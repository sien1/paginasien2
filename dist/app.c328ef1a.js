...
$(document).ready(function () {
  ...
  var displayer = function displayer(hash) {
    ...
    var paragraph = $("<p></p>").appendTo(".contenido .testo"); // gsap.to(".delimiter", {duration: .9, opacity: 0, y:-100} );

    retriever(hash).then(function (text, err) {
      // $(".bg-special").css("background-image", "url('"+text.bgimg+"')");
      $(title).text(text.Titulo);
      $(subtitle).text(text.Subtitulo);
      $(paragraph).text(text.parrafo);
      gsap.to([".contenido .margen"], {
        duration: 3,
        opacity: 1
      });
      gsap.from([title, subtitle, paragraph], {
        duration: 3,
        opacity: 0
      }, 93);
    });
  ...
  var retriever = function retriever(x) {
    return new Promise(function (resolve, reject) {
      var chorizo = data.find(function (element) {
        return element.hash == x;
      });

      if (!chorizo) {
        chorizo = data.find(function (element) {
          return element.Id == 1;
        });
      }
...
},{"./data.json":"data.json"}],"../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
