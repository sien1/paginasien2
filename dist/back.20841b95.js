...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"scripts/back.js":[function(require,module,exports) {
"use strict";
...
$(document).ready(function () {
  ...
  $.getJSON("data.json", function (data) {
    ...
    data.forEach(function (element, i) {
      loader.add("image".concat(i + 1), "./imgs/".concat(element.img));
    });
    loader.on('complete', function (loader, resources) {
      var Filter = new PIXI.Filter(null, _fragment.default);
      var background = new PIXI.Sprite(resources.image2.texture);
      ...
      $('.view').click(function (e) {
        var element = data.find(function (x) {
          return e.target.hash === x.hash;
        });
      });
...
//     // });
// });
},{"../fragment.glsl":"fragment.glsl","gsap":"node_modules/gsap/index.js"}],"../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/back.js"], null)
//# sourceMappingURL=/back.20841b95.js.map